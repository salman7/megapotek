...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo base_url() ?>index.php/obat">MEGAPOTEK</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="<?php echo base_url() ?>index.php/obat">Obat</a></li>
        <li class="active"><a href="<?php echo base_url() ?>index.php/user">Pengguna</a></li>
